...
command_line ="gfsh start server --name=server1 --dir=server1 --cache-xml-file=./config/cache.xml --properties-file=./config/gemfire.properties --classpath=../ecommerce.jar --server-port=40404"
